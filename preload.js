...
contextBridge.exposeInMainWorld("aivudaShell", {
  ...
  onResetZoom: (callback) => ipcRenderer.on("aivuda-shell:reset-zoom", callback),
  ...
  onZoomIn: (callback) => ipcRenderer.on("aivuda-shell:zoom-in", callback),
  onZoomOut: (callback) => ipcRenderer.on("aivuda-shell:zoom-out", callback),
